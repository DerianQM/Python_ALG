...
def main(s,a,b,start,step,check,fl):
    while fl == 0 :
        while start<step:
            a.append(start)
            start+=1
...
print(timeit.timeit('main(s,a,b,start,step,check,fl)', setup = 'from __main__ import main,s,a,b,start,step,check,fl', number =1))